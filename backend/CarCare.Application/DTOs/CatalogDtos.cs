namespace CarCare.Application.DTOs
{
    // --- KATEGORÝ ---
    ...
    public class ProductListDto
    {
        ...
        public List<VariantListDto> Variants { get; set; } // Ýç içe liste
    }
    ...
    public class CreateProductDto
    {
        ...
        public bool HasMicron { get; set; } // True ise fiyat 0 gönderilmeli veya backend 0 yapmalý
        public decimal BasePrice { get; set; }
    }
    ...
    {
        public int ProductId { get; set; } // Hangi ürüne baðlý
        public string Name { get; set; }
        public string ThicknessCode { get; set; }
        public bool HasSubParts { get; set; }
        public decimal VariantPrice { get; set; }
    ...
    {
        public int VariantId { get; set; } // Hangi varyanta baðlý
        public string PartName { get; set; }
        public decimal Price { get; set; }
        public bool IsExtra { get; set; }
    }
